...
description: Interpolazioni utilizzate per le immagini in scala.
type: docs
weight: 60
url: /it/net/aspose.ocr.filters/interpolationfiltertype/
---
## InterpolationFilterType enumeration

Interpolazioni, utilizzate per le immagini in scala.
...
| --- | --- | --- |
| Box | `0` | Il filtro 'Box' o 'Nearest Neighbor' http://www.imagemagick.org/Usage/filter/#box |
| Triangle | `1` | Il filtro di interpolazione 'Triangolo' o 'Bilineare' porta l'interpolazione del quartiere più vicino un ulteriore passo avanti. http://www.imagemagick.org/Usage/filter/#triangle |
...
| CatmullRom | `8` | Il filtro 'Catrom' (Catmull-Rom) è un ben noto filtro cubico standard spesso utilizzato come funzione di interpolazione. http://www.imagemagick.org/Usage/filter/#catrom-c |
...
* spazio dei nomi [Aspose.OCR.Filters](../../aspose.ocr.filters)
