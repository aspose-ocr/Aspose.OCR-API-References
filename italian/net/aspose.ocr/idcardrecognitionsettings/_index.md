...
description: Aspose.OCR.IDCardRecognitionSettings classe. Impostazioni per il riconoscimento della carta didentità. Contiene elementi che consentono di personalizzare il processo di riconoscimento.
type: docs
weight: 90
url: /it/net/aspose.ocr/idcardrecognitionsettings/
---
## IDCardRecognitionSettings class

Impostazioni per il riconoscimento della carta d'identità. Contiene elementi che consentono di personalizzare il processo di riconoscimento.
...
| Nome | Descrizione |
| --- | --- |
| [IDCardRecognitionSettings](idcardrecognitionsettings/)(Language) | Inizializza una nuova istanza di`IDCardRecognitionSettings`classe con set completo di proprietà. |
