...
description: Aspose.OCR.PassportRecognitionSettings classe. Impostazioni per il riconoscimento del passaporto. Contiene elementi che consentono di personalizzare il processo di riconoscimento.
type: docs
weight: 190
url: /it/net/aspose.ocr/passportrecognitionsettings/
---
...
| Nome | Descrizione |
| --- | --- |
| [PassportRecognitionSettings](passportrecognitionsettings/)(Language) | Inizializza una nuova istanza di`PassportRecognitionSettings`classe con set completo di proprietà. |
