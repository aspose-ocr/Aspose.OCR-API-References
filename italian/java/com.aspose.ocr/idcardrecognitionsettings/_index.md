...
description: "Impostazioni per il riconoscimento della carta d'identità Contiene elementi che consentono di personalizzare il processo di riconoscimento"
type: docs
weight: 14
url: /it/java/com.aspose.ocr/idcardrecognitionsettings/
---
...
| --- | --- |
| [IDCardRecognitionSettings()](#IDCardRecognitionSettings) | Costruttore predefinito: imposta autoSkew true. |
## Metodi
