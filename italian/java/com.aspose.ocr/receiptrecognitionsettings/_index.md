...
description: "Impostazioni per il riconoscimento delle ricevute Contiene elementi che consentono di personalizzare il processo di riconoscimento"
type: docs
weight: 25
url: /it/java/com.aspose.ocr/receiptrecognitionsettings/
---
...
| --- | --- |
| [ReceiptRecognitionSettings()](#ReceiptRecognitionSettings) | Costruttore predefinito: imposta autoSkew true. |
## Metodi
