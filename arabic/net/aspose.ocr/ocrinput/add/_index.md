...
| معامل | نوع | الوصف |
| --- | --- | --- |
| تدفق | MemoryStream | دفق الذاكرة الذي يحتوي على الصورة أو المستند. |
...
| --- | --- | --- |
| fullPath | String | المسار إلى الصورة/ المستند / المجلد / الأرشيف. |
| startPage | Int32 | الصفحة/الصورة الأولى للمعالجة / التعرف. استخدم للمستندات، ملفات zip، المجلدات. |
| pagesCount | Int32 | الإجمالي الكلي للصفحات/الصور للمعالجة / التعرف. استخدم للمستندات، ملفات zip، المجلدات. القيمة الافتراضية = 1. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| تدفق | MemoryStream | دفق الذاكرة الذي يحتوي على المستند متعدد الصفحات. |
| startPage | Int32 | الصفحة/الصورة الأولى للمعالجة / التعرف. استخدم للمستندات. |
| pagesCount | Int32 | الإجمالي الكلي للصفحات/الصور للمعالجة / التعرف. استخدم للمستندات. القيمة الافتراضية = 1. |
