...
| Name | الوصف |
| --- | --- |
| [PassportRecognitionSettings](passportrecognitionsettings#constructor)() | إنشاء نسخة جديدة من الفئة [`PassportRecognitionSettings`](../passportrecognitionsettings) مع مجموعة الخصائص الافتراضية. |
| [PassportRecognitionSettings](passportrecognitionsettings#constructor_1)(Language) | إنشاء نسخة جديدة من الفئة [`PassportRecognitionSettings`](../passportrecognitionsettings) مع مجموعة كاملة من الخصائص. |
...
| [Country](../../aspose.ocr/passportrecognitionsettings/country) { get; set; } | تعيين القالب للتعرف على جواز السفر واستخراج الكلمات المفتاحية. |
