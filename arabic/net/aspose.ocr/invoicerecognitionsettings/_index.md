...
| الاسم | الوصف |
| --- | --- |
| [InvoiceRecognitionSettings](invoicerecognitionsettings#constructor)() | يُنشئ مثيلًا جديدًا من الفئة [`InvoiceRecognitionSettings`](../invoicerecognitionsettings) مع مجموعة الخصائص الافتراضية. |
| [InvoiceRecognitionSettings](invoicerecognitionsettings#constructor_1)(Language) | يُنشئ مثيلًا جديدًا من الفئة [`InvoiceRecognitionSettings`](../invoicerecognitionsettings) مع مجموعة كاملة من الخصائص. |
