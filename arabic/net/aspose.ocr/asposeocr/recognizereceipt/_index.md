...
يتعرف على الفاتورة مع القدرة على تحديد [`ReceiptRecognitionSettings`](../../receiptrecognitionsettings). يدعم GIF, PNG, JPEG, BMP, TIFF, JFIF، التدفق، الدليل، المصفوفات، الأرشيفات.
