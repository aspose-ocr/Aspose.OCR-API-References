...
description: "يتعرف على النص من صورة DJVU متعددة الصفحات. يتعرف على ملف DJVU مع القدرة على تحديد DocumentRecognitionSettingsaspose.ocr/documentrecognitionsettings. يدعم DJVU فقط. لا يدعم أنواع الصور الأخرى."
type: docs
weight: 120
...
يتعرف على النص من صورة DJVU متعددة الصفحات. يتعرف على ملف DJVU مع القدرة على تحديد [`DocumentRecognitionSettings`](../../documentrecognitionsettings). يدعم DJVU فقط. لا يدعم أنواع الصور الأخرى.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| دفق | MemoryStream | دفق الذاكرة مع ملف DJVU. |
| الإعدادات | DocumentRecognitionSettings | إعدادات التعرف. |
