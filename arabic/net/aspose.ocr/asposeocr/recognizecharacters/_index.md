...
description: "يكتشف الرموز على الصور. يدعم GIF PNG JPEG BMP TIFF JFIF تدفق المجلدات والمصفوفات والأرشيفات."
type: docs
weight: 160
...
يكشف عن الرموز على الصور. يدعم GIF و PNG و JPEG و BMP و TIFF و JFIF، التدفق، المجلد، المصفوفات، الأرشيفات.
