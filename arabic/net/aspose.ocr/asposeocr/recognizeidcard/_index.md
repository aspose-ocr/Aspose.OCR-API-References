...
يتعرف على بطاقات الهوية مع القدرة على تحديد [`IDCardRecognitionSettings`](../../idcardrecognitionsettings). يدعم GIF, PNG, JPEG, BMP, TIFF, JFIF، التدفق، الدليل، المصفوفات، الأرشيفات.
