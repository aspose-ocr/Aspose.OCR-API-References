...
description: "ينشئ نسخة جديدة من الفئة DocumentRecognitionSettingsaspose.ocr/documentrecognitionsettings مع مجموعة مختصرة من الخصائص."
type: docs
weight: 10
...
ينشئ نسخة جديدة من الفئة [`DocumentRecognitionSettings`](../../documentrecognitionsettings) مع مجموعة مختصرة من الخصائص.
...
| pagesNumber | Int32 | حدد عدد الصفحات للتعرف على ملف PDF متعدد الصفحات. |
...
| autoSkew | Boolean | تمكين تصحيح الانحراف التلقائي للصورة. |
