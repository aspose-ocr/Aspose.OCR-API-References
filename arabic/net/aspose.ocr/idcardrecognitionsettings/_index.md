...
description: "إعدادات التعرف على بطاقة الهوية. يحتوي على عناصر تسمح بتخصيص عملية التعرف."
type: docs
weight: 190
...
إعدادات التعرف على بطاقة الهوية. يحتوي على عناصر تسمح بتخصيص عملية التعرف.
