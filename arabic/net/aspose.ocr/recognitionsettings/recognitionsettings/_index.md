...
description: RecognitionSettings البناء. يقوم بتهيئة مثيل جديد لملفRecognitionSettingsفئة بمجموعة كاملة من الخصائص.
type: docs
weight: 10
...
يقوم بتهيئة مثيل جديد لملف[`RecognitionSettings`](../)فئة بمجموعة كاملة من الخصائص.
