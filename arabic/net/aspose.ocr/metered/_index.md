...
| اسم | وصف |
| --- | --- |
| [SetMeteredKey](../../aspose.ocr/metered/setmeteredkey)(string, string) | مجموعات المفاتيح العامة والخاصة التي تم قياسها |
| static [GetConsumptionCredit](../../aspose.ocr/metered/getconsumptioncredit)() | يحصل على ائتمان الاستهلاك |
