...
description: عمليات الإقحام  تُستخدم لمقياس الصور.
type: docs
weight: 60
...
| Triangle | `1` | يأخذ مرشح الاستيفاء "المثلث" أو "Bilinear" عملية الاستيفاء لأقرب حي خطوة أخرى . http://www.imagemagick.org/Usage/filter/#triangle |
...
| CubicConvolution | `11` | https://ar.wikipedia.org/wiki/Directional_Cubic_Convolution_Interpolation |
| Lanczos8 | `12` | https://en.wikipedia.org/wiki/Lanczos_resampling |

### أنظر أيضا

* مساحة الاسم [Aspose.OCR.Filters](../../aspose.ocr.filters)
* المجسم [Aspose.OCR](../../)
