...
| Name | القيمة | الوصف |
| --- | --- | --- |
| Box | `0` | الـ 'Box' أو 'Nearest Neighbor' filter http://www.imagemagick.org/Usage/filter/#box |
| Triangle | `1` | الـ 'Triangle' أو 'Bilinear' interpolation filter يأخذ استيفاء الجوار الأقرب خطوةً إضافية. http://www.imagemagick.org/Usage/filter/#triangle |
...
| CatmullRom | `8` | الـ 'Catrom' (Catmull-Rom) filter هو مرشح مكعب قياسي معروف يُستخدم غالبًا كدالة استيفاء. http://www.imagemagick.org/Usage/filter/#catrom-c |
