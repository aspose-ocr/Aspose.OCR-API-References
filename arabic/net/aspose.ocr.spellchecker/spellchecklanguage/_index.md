...
description: "اللغات المستخدمة لتدقيق الإملاء في القواميس الموجودة."
type: docs
weight: 520
...
اللغات المستخدمة في SpellCheck (القواميس الموجودة).
...
| Fin | `10` | قاموس فنلندي |
| Lav | `11` | قاموس لاتفيا |
| Lit | `12` | قاموس ليتواني |
| Pol | `13` | قاموس بولندي |
| Ron | `14` | قاموس روماني |
| Slk | `15` | قاموس سلوفاكي |
| Slv | `16` | قاموس سلوفيني |
| Swe | `17` | قاموس سويدي |
