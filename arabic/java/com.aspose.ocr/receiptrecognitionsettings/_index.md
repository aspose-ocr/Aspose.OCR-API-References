...
description: "إعدادات التعرف على الإيصالات تحتوي على عناصر تسمح بتخصيص عملية التعرف."
type: docs
weight: 25
url: /ar/java/com.aspose.ocr/receiptrecognitionsettings/
---
...
| منشئ | الوصف |
| --- | --- |
| [ReceiptRecognitionSettings()](#ReceiptRecognitionSettings) | المنشئ الافتراضي: اضبط autoSkew إلى true. |
## الطرق
