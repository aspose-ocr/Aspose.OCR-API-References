...
| [RecognitionSettings](../com.aspose.ocr/recognitionsettings/) | إعدادات التعرف على الصورة. |
| [RectangleOutput](../com.aspose.ocr/rectangleoutput/) | بيانات حول مناطق النص المكتشفة أو السطور. |
| [Resources](../com.aspose.ocr/resources/) | إدارة الموارد القابلة للتنزيل التي تعزز قدرات التعرف في Aspose.OCR. |

## التعدادات

| تعداد | الوصف |
| --- | --- |
| [InputType](../com.aspose.ocr/inputtype/) | أنواع الصور/ المستندات للمعالجة / التعرف. |
