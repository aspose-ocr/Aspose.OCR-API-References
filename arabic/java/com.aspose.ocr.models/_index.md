...
type: docs
weight: 13
url: /ar/java/com.aspose.ocr.models/
---
...
| [OCRTable](../com.aspose.ocr.models/ocrtable/) | يمثل جدولًا واحدًا ببيانات جدولة معترف بها. |
| [OCRTableCell](../com.aspose.ocr.models/ocrtablecell/) | يمثل خلية جدول واحدة بنص معترف به ومعلومات الموقع. |
| [OCRTablePage](../com.aspose.ocr.models/ocrtablepage/) | يمثل بيانات جدول منظمة لصفحة المستند OCR بالكامل. |
| [OCRTableRow](../com.aspose.ocr.models/ocrtablerow/) | يمثل صفًا واحدًا داخل جدول معترف به. |
| [OnnxRuntimeSessionOptions](../com.aspose.ocr.models/onnxruntimesessionoptions/) | خيارات التكوين لإنشاء ONNX InferenceSession. |
| [SkewOutput](../com.aspose.ocr.models/skewoutput/) | بيانات حول زاوية الانحراف بالدرجات واسم الملف. |
