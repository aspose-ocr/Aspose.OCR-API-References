...
يعطي الأولوية للسرعة ويقلل استهلاك الموارد عن طريق حذف دعم التخطيطات المعقدة. مناسب فقط للصور البسيطة التي تحتوي على عدد قليل من سطور النص دون رسومات أو تنسيق.
...
يكتشف كتل نصية كبيرة مُنسقة في أعمدة. الخيار الأفضل للتخطيطات متعددة الأعمدة مثل صفحات الكتب أو المقالات أو العقود.
...
يكتشف الهياكل الجدولية في الصورة ويستخرج النص من الخلايا الفردية. يُنصح به للبيانات الممسوحة ضوئيًا مثل جداول البيانات، التقارير، وغيرها من المستندات القائمة على الجداول.
