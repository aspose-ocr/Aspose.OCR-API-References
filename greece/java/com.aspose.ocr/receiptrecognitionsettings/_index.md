...
description: "Ρυθμίσεις για την αναγνώριση απόδειξης. Περιέχει στοιχεία που επιτρέπουν την προσαρμογή της διαδικασίας αναγνώρισης."
type: docs
weight: 25
url: /el/java/com.aspose.ocr/receiptrecognitionsettings/
---
...
| --- | --- |
| [ReceiptRecognitionSettings()](#ReceiptRecognitionSettings) | Προεπιλεγμένος κατασκευαστής: ορίστε autoSkew σε true. |
## Μέθοδοι
