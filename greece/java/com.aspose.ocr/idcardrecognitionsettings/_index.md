...
description: "Ρυθμίσεις για την αναγνώριση ταυτότητας. Περιέχει στοιχεία που επιτρέπουν την προσαρμογή της διαδικασίας αναγνώρισης."
type: docs
weight: 14
url: /el/java/com.aspose.ocr/idcardrecognitionsettings/
---
...
Ρυθμίσεις για την αναγνώριση ταυτότητας. Περιέχει στοιχεία που επιτρέπουν την προσαρμογή της διαδικασίας αναγνώρισης.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [IDCardRecognitionSettings()](#IDCardRecognitionSettings) | Προεπιλεγμένος κατασκευαστής: ορίστε autoSkew σε true. |
## Μέθοδοι
