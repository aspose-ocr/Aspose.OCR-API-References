...
description: Aspose.OCR.BaseRecognitionSettings τάξη. Ρυθμίσεις για την αναγνώριση εικόνας. Περιέχει στοιχεία που επιτρέπουν την προσαρμογή της διαδικασίας αναγνώρισης.
type: docs
weight: 30
url: /el/net/aspose.ocr/baserecognitionsettings/
---
...
| Ονομα | Περιγραφή |
| --- | --- |
| [BaseRecognitionSettings](baserecognitionsettings/)(Language, bool, float, int) | Αρχικοποιεί μια νέα παρουσία του[`RecognitionSettings`](../recognitionsettings/)κλάση με πλήρες σύνολο ιδιοτήτων. |
...
| [SkewAngle](../../aspose.ocr/baserecognitionsettings/skewangle/) { set; } | Λαμβάνει ή ρυθμίζει τη γωνία σε μοίρες για την περιστροφή της εικόνας.  Η ρύθμιση αυτής της τιμής θα απενεργοποιήσει το[`AutoSkew`](./autoskew/) ιδιότητα, έτσι ώστε να μην εφαρμόζεται η αυτόματη διόρθωση λοξού. Μηδέν από προεπιλογή. |
