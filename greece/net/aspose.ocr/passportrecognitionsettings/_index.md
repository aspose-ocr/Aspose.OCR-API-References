...
description: Aspose.OCR.PassportRecognitionSettings τάξη. Ρυθμίσεις για την αναγνώριση διαβατηρίου. Περιέχει στοιχεία που επιτρέπουν την προσαρμογή της διαδικασίας αναγνώρισης.
type: docs
weight: 190
url: /el/net/aspose.ocr/passportrecognitionsettings/
---
...
| Ονομα | Περιγραφή |
| --- | --- |
| [PassportRecognitionSettings](passportrecognitionsettings/)(Language) | Αρχικοποιεί μια νέα παρουσία του`PassportRecognitionSettings`κλάση με πλήρες σύνολο ιδιοτήτων. |
