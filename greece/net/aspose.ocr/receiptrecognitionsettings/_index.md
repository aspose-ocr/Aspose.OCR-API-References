...
description: Aspose.OCR.ReceiptRecognitionSettings τάξη. Ρυθμίσεις για την αναγνώριση απόδειξης. Περιέχει στοιχεία που επιτρέπουν την προσαρμογή της διαδικασίας αναγνώρισης.
type: docs
weight: 210
url: /el/net/aspose.ocr/receiptrecognitionsettings/
---
...
| Ονομα | Περιγραφή |
| --- | --- |
| [ReceiptRecognitionSettings](receiptrecognitionsettings/)(Language) | Αρχικοποιεί μια νέα παρουσία του`ReceiptRecognitionSettings`κλάση με πλήρες σύνολο ιδιοτήτων. |
