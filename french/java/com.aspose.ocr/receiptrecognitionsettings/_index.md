...
description: "Paramètres pour la reconnaissance de reçus. Contient des éléments qui permettent de personnaliser le processus de reconnaissance."
type: docs
weight: 25
url: /fr/java/com.aspose.ocr/receiptrecognitionsettings/
---
...
| --- | --- |
| [ReceiptRecognitionSettings()](#ReceiptRecognitionSettings) | Constructeur par défaut : définir autoSkew sur true. |
## Méthodes
