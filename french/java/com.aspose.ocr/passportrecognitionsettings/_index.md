...
description: "Paramètres pour la reconnaissance de passeport. Contient des éléments qui permettent de personnaliser le processus de reconnaissance."
type: docs
weight: 23
url: /fr/java/com.aspose.ocr/passportrecognitionsettings/
---
...
| [setCountry(Country country)](#setCountry-com.aspose.ocr.models.Country) | Définissez le modèle pour la reconnaissance de passeport et pour extraire les mots-clés. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| country | [Country](../../com.aspose.ocr.models/country/) | pays du passeport. |
