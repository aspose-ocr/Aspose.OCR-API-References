...
description: "Paramètres pour la reconnaissance de la carte d'identité. Contient des éléments qui permettent de personnaliser le processus de reconnaissance."
type: docs
weight: 14
url: /fr/java/com.aspose.ocr/idcardrecognitionsettings/
---
...
Paramètres pour la reconnaissance de la carte d'identité. Contient des éléments qui permettent de personnaliser le processus de reconnaissance.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [IDCardRecognitionSettings()](#IDCardRecognitionSettings) | Constructeur par défaut : définir autoSkew sur true. |
## Méthodes
