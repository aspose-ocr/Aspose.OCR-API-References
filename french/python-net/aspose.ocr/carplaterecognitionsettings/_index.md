...
type: docs
weight: 40
url: /fr/python-net/aspose.ocr/carplaterecognitionsettings/
---

## CarPlateRecognitionSettings class

Paramètres pour la reconnaissance des numéros de voiture.<br/>            Contient des éléments qui permettent de personnaliser le processus de reconnaissance.

Le type CarPlateRecognitionSettings expose les membres suivants :
## Constructors
| Name | Description |
| :- | :- |
| CarPlateRecognitionSettings(language) | Initialise une nouvelle instance de la classe CarPlateRecognitionSettings |
| CarPlateRecognitionSettings() | Initialise une nouvelle instance de |
## Properties
| Name | Description |
| :- | :- |
