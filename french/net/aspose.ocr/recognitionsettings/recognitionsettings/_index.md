...
description: RecognitionSettings constructeur. Initialise une nouvelle instance duRecognitionSettingsclasse avec un ensemble complet de propriétés.
type: docs
weight: 10
...
Initialise une nouvelle instance du[`RecognitionSettings`](../)classe avec un ensemble complet de propriétés.
