...
description: Initialise une nouvelle instance duDocumentRecognitionSettingsaspose.ocr/documentrecognitionsettings classe avec un ensemble court de propriétés.
type: docs
weight: 10
...
Initialise une nouvelle instance du[`DocumentRecognitionSettings`](../../documentrecognitionsettings) classe avec un ensemble court de propriétés.
...
Initialise une nouvelle instance du[`DocumentRecognitionSettings`](../../documentrecognitionsettings) classe avec un ensemble complet de propriétés.
