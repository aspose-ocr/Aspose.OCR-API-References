...
description: Aspose.OCR.IDCardRecognitionSettings classe. Paramètres pour la reconnaissance de la carte didentité. Contient des éléments permettant de personnaliser le processus de reconnaissance.
type: docs
weight: 90
url: /fr/net/aspose.ocr/idcardrecognitionsettings/
---
## IDCardRecognitionSettings class

Paramètres pour la reconnaissance de la carte d'identité. Contient des éléments permettant de personnaliser le processus de reconnaissance.
...
| Nom | La description |
| --- | --- |
| [IDCardRecognitionSettings](idcardrecognitionsettings/)(Language) | Initialise une nouvelle instance du`IDCardRecognitionSettings`classe avec un ensemble complet de propriétés. |
