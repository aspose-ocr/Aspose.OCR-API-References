...
description: Ölçekli görüntüler için kullanılan enterpolasyonlar.
type: docs
weight: 60
...
| İsim | Değer | Tanım |
| --- | --- | --- |
| Box | `0` | 'Kutu' veya 'En Yakın Komşu' filterю http://www.imagemagick.org/Usage/filter/#box |
| Triangle | `1` | 'Üçgen' veya 'Bilinear' enterpolasyon filtresi, en yakın komşuluğun enterpolasyonunu bir adım daha ileri götürür. http://www.imagemagick.org/Usage/filter/#triangle |
...
| CatmullRom | `8` | 'Catrom' (Catmull-Rom) filtresi, iyi bilinen bir standart Kübik Filtredir, genellikle bir enterpolasyon işlevi olarak kullanılır. http://www.imagemagick.org/Usage/filter/#catrom-c |
