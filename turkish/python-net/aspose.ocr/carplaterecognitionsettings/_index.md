...
type: docs
weight: 40
url: /tr/python-net/aspose.ocr/carplaterecognitionsettings/
---

## CarPlateRecognitionSettings class

Araç numarası tanıma ayarları.<br/>            Tanıma sürecini özelleştirmeye izin veren öğeleri içerir.

CarPlateRecognitionSettings türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| CarPlateRecognitionSettings(language) | CarPlateRecognitionSettings sınıfının yeni bir örneğini başlatır. |
| CarPlateRecognitionSettings() | Yeni bir örnek başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
