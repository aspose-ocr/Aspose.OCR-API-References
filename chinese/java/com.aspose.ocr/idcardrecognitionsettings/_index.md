...
description: "身份证识别的设置包含允许自定义识别过程的元素。"
type: docs
weight: 14
url: /zh/java/com.aspose.ocr/idcardrecognitionsettings/
---
...
身份证识别的设置包含允许自定义识别过程的元素。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [IDCardRecognitionSettings()](#IDCardRecognitionSettings) | 默认构造函数：将 autoSkew 设置为 true。 |
## 方法
