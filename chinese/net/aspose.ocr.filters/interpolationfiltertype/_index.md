...
| 名称 | 值 | 描述 |
| --- | --- | --- |
| Box | `0` | ‘Box’ 或 ‘Nearest Neighbor’ 过滤器 http://www.imagemagick.org/Usage/filter/#box |
| Triangle | `1` | ‘Triangle’ 或 ‘Bilinear’ 插值过滤器只是将最近邻的插值再进一步。 http://www.imagemagick.org/Usage/filter/#triangle |
