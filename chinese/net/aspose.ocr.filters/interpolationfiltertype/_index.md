...
| Name | Value | 描述 |
| --- | --- | --- |
| Box | `0` | ‘Box’ 或 ‘Nearest Neighbor’ 滤镜 http://www.imagemagick.org/Usage/filter/#box |
| Triangle | `1` | ‘Triangle’ 或 ‘Bilinear’ 插值滤镜仅在最近邻插值的基础上再进一步。 http://www.imagemagick.org/Usage/filter/#triangle |
...
| CatmullRom | `8` | ‘Catrom’ (Catmull-Rom) 滤镜是一种广为人知的标准立方滤镜，常用作插值函数。 http://www.imagemagick.org/Usage/filter/#catrom-c |
