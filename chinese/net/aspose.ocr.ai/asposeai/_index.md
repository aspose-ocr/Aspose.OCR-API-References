...
| [RunPostprocessor](../../aspose.ocr.ai/asposeai/runpostprocessor#runpostprocessor)(OcrOutput) | 对给定的结构化 OCR 结果应用已注册的 AI 后处理器。这可能包括拼写纠正、表格检测、表格格式化以及其他基于 AI 的增强功能，具体取决于配置的处理器。 |
