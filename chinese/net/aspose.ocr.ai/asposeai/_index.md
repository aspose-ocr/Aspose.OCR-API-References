...
description: "Aspose OCR 库中 AI 组件的主要 API。提供与 AI 驱动的后处理器（如拼写检查表格提取和布局校正）的集成。"
type: docs
weight: 630
...
| [RunPostprocessor](../../aspose.ocr.ai/asposeai/runpostprocessor#runpostprocessor_1)(List&lt;string&gt;) | 对识别的文本字符串列表应用已注册的 AI 后处理器。 |
| [RunPostprocessor](../../aspose.ocr.ai/asposeai/runpostprocessor#runpostprocessor)(OcrOutput) | 对给定的结构化 OCR 结果应用已注册的 AI 后处理器。这可能包括拼写校正、表格检测、表格格式化以及其他基于 AI 的增强，具体取决于已配置的处理器。 |
