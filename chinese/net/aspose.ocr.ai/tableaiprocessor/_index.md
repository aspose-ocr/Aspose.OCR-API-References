...
| 名称 | 描述 |
| --- | --- |
| [TableAIProcessor](tableaiprocessor)(AITableDetectionMode) | 使用指定的表检测模式初始化 [`TableAIProcessor`](../tableaiprocessor) 类的新实例。该模式定义了如何从识别的文本中检测、结构化和处理表格。 |

## 方法

| 名称 | 描述 |
| --- | --- |
| [GetResult](../../aspose.ocr.ai/tableaiprocessor/getresult)() | 获取表检测和结构化后的处理过的 OCR 结果。 |
