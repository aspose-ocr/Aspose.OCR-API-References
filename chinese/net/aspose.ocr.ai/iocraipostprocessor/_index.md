...
| [Process](../../aspose.ocr.ai/iocraipostprocessor/process#process)(OcrOutput) | 使用此 AI 后处理器处理 OCR 结果，可选地在指定模式或区域检测表格。 |
| [SetAI](../../aspose.ocr.ai/iocraipostprocessor/setai)(AsposeAI) | 注入 AsposeAI 类的实例，以提供 AI 功能访问。这使得处理器可以与特定的 AI 实现解耦。 |
