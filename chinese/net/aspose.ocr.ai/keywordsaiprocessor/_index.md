...
| 名称 | 描述 |
| --- | --- |
| [KeywordsAIProcessor](keywordsaiprocessor)() | 初始化 [`KeywordsAIProcessor`](../keywordsaiprocessor) 类的新实例。在 OCR 识别的文本中执行基于 AI 的关键字和数值搜索。 |
...
| [SaveTxt](../../aspose.ocr.ai/keywordsaiprocessor/savetxt)(string) | 将提取的表格和处理后的文本结果保存为 TXT 文件。 |
