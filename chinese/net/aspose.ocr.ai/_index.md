...
| 类 | 描述 |
| --- | --- |
| [AIResult](./airesult) | 表示 AI 处理的识别结果。 |
...
| 接口 | 描述 |
| --- | --- |
| [IOcrAIPostProcessor](./iocraipostprocessor) | 用于对 OCR 识别结果进行 AI 基础后处理的接口。 |
## 枚举

| 枚举 | 描述 |
| --- | --- |
| [AITableDetectionMode](./aitabledetectionmode) | 定义用于改进表格布局识别的表格检测模式。 |
