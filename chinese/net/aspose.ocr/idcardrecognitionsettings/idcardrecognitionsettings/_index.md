...
description: 使用完整属性集初始化 IDCardRecognitionSettingsaspose.ocr/idcardrecognitionsettings 类的新实例。
type: docs
weight: 10
...
使用完整属性集初始化 [`IDCardRecognitionSettings`](../../idcardrecognitionsettings) 类的新实例。
...
使用默认属性集初始化 [`IDCardRecognitionSettings`](../../idcardrecognitionsettings) 类的新实例。
