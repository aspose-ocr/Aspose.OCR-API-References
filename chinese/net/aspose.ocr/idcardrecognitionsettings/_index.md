...
description: Aspose.OCR.IDCardRecognitionSettings 班级. ID 卡识别设置 包含允许自定义识别过程的元素
type: docs
weight: 90
...
| 姓名 | 描述 |
| --- | --- |
| [IDCardRecognitionSettings](idcardrecognitionsettings/)(Language) | 初始化一个新的实例`IDCardRecognitionSettings`具有全套属性的类. |
