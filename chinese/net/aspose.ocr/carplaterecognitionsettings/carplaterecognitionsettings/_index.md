...
description: 初始化 CarPlateRecognitionSettingsaspose.ocr/carplaterecognitionsettings 类的新实例，包含完整的属性集合。
type: docs
weight: 10
...
初始化 [`CarPlateRecognitionSettings`](../../carplaterecognitionsettings) 类的新实例，包含完整的属性集合。
...
初始化 [`CarPlateRecognitionSettings`](../../carplaterecognitionsettings) 类的新实例，使用默认的属性集合。
