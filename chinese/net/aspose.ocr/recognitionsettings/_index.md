...
| [RecognitionSettings](recognitionsettings#constructor_1)(Language, List&lt;Rectangle&gt;, bool) | 初始化一个新的 [`RecognitionSettings`](../recognitionsettings) 类实例，包含完整的属性集。 |
...
| [AutomaticColorInversion](../../aspose.ocr/baserecognitionsettings/automaticcolorinversion) { get; set; } | 检测暗色/黑色背景上白色文字的图像，并自动为其选择特殊的 OCR 算法。 |
...
| [LanguageDetectionLevel](../../aspose.ocr/recognitionsettings/languagedetectionlevel) { get; set; } | 指定文本识别的语言检测级别。仅当所选语言为 Multilanguage、Auto 或 Universal 时才有效。此过程耗时，并显著降低整体识别速度。 |
| [LinesFiltration](../../aspose.ocr/recognitionsettings/linesfiltration) { get; set; } | 允许识别表格中的文本（被线条包围的区域）。 |
| [RecognitionAreas](../../aspose.ocr/recognitionsettings/recognitionareas) { get; set; } | 获取或设置用于处理的文本区域列表。允许手动指定包含文本的区域以获得更精确的识别。禁用 AutoSkew。 |
