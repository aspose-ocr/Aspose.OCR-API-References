...
description: Aspose.OCR.InvoiceRecognitionSettings 班级. 发票识别设置 包含允许自定义识别过程的元素
type: docs
weight: 100
...
| 姓名 | 描述 |
| --- | --- |
| [InvoiceRecognitionSettings](invoicerecognitionsettings/)(Language) | 初始化一个新的实例`InvoiceRecognitionSettings`具有全套属性的类. |
