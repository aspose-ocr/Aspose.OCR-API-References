...
description: 从多页 TIFF 图像中识别文字。能够指定 DocumentRecognitionSettingsaspose.ocr/documentrecognitionsettings 来识别 TIFF 文件。仅支持 TIFF/TIF。不支持其他图像类型。
type: docs
weight: 240
...
从多页 TIFF 图像中识别文字。能够指定 [`DocumentRecognitionSettings`](../../documentrecognitionsettings) 来识别 TIFF 文件。仅支持 TIFF（TIF）。不支持其他图像类型。
