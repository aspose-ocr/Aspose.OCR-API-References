...
description: 从多页 DJVU 图像识别文本。识别 DJVU 文件，并可指定 DocumentRecognitionSettingsaspose.ocr/documentrecognitionsettings。仅支持 DJVU。不支持其他图像类型。
type: docs
weight: 120
...
从多页 DJVU 图像识别文本。识别 DJVU 文件，并可指定 [`DocumentRecognitionSettings`](../../documentrecognitionsettings)。仅支持 DJVU。不支持其他图像类型。
