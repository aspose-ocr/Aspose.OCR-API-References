...
description: 识别街道照片上的文本。
type: docs
weight: 200
url: /zh/net/aspose.ocr/asposeocr/recognizestreetphoto/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| input | OcrInput | 包含源的容器。[`OcrInput`](../../ocrinput) |
...
从街道照片、交通摄像头图像、身份证、驾驶执照以及其他文本稀疏且背景嘈杂/彩色的图像中提取文本。支持 GIF、PNG、JPEG、BMP、TIFF、JFIF、流、目录、数组、归档。
