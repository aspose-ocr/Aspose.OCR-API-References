...
description: 识别扫描的 PDF 文本并提取图像。识别 PDF 文件并可指定 DocumentRecognitionSettingsaspose.ocr/documentrecognitionsettings。仅支持扫描的 PDF。不支持可搜索的 PDF。
type: docs
weight: 220
...
识别扫描的 PDF（提取图像）。识别 PDF 文件并可指定 [`DocumentRecognitionSettings`](../../documentrecognitionsettings)。仅支持扫描的 PDF。不支持可搜索的 PDF。
...
识别扫描的 PDF（提取图像）。识别 PDF 文件并可指定 [`RecognitionSettings`](../../recognitionsettings)。仅支持扫描的 PDF。不支持可搜索的 PDF。
