...
description: 从扫描的 PDF 中提取图像并识别文本。识别 PDF 文件并可指定 DocumentRecognitionSettingsaspose.ocr/documentrecognitionsettings。仅支持扫描的 PDF。不支持可搜索的 PDF。
type: docs
weight: 220
...
从扫描的 PDF（提取图像）中识别文本。识别 PDF 文件并可指定 [`DocumentRecognitionSettings`](../../documentrecognitionsettings)。仅支持扫描的 PDF。不支持可搜索的 PDF。
...
从扫描的 PDF（提取图像）中识别文本。识别 PDF 文件并可指定 [`RecognitionSettings`](../../recognitionsettings)。仅支持扫描的 PDF。不支持可搜索的 PDF。
