...
description: 检测表格并结构化识别文本单元格。支持 GIF PNG JPEG BMP TIFF JFIF 流 目录 数组 归档。
type: docs
weight: 250
...
检测表格和结构，识别文本单元格。支持 GIF、PNG、JPEG、BMP、TIFF、JFIF、流、目录、数组、压缩包。
...
| language | 语言 | 确定识别过程中使用的字母表。 |

### 返回值

包含表格中已识别文本的 [`OCRTablePage`](../../ocrtablepage) 对象列表。
