...
---
该 **Aspose.OCR** 包含用于图像识别、倾斜校正、文本区域检测和拼写检查的工具。
...
| [LayoutOutput](./layoutoutput) | 关于图像中检测到的内容区域的信息。 |
| [License](./license) | 提供对组件授权的方法。 |
| [Logging](./logging) | 用于创建日志配置的类。 |
| [Metered](./metered) | 提供设置计量密钥的方法。 |
| [OcrInput](./ocrinput) | 用于收集所有图像/文档进行预处理/识别的容器。 |
