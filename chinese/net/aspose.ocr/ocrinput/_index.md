...
description: 用于收集所有图像/文档进行预处理/识别的容器。
type: docs
weight: 410
...
| Name | 描述 |
| --- | --- |
| [OcrInput](ocrinput)(InputType, PreprocessingFilter) | 构造函数用于创建容器并设置图像/文档的类型以及后续预处理/识别的过滤器。 |
...
| [Add](../../aspose.ocr/ocrinput/add#add)(Color[], int, int) | 将解码后的图像添加到列表中以进行识别/处理。图像的类型必须与构造函数中指定的类型（SingleImage）相匹配。 |
...
| [Add](../../aspose.ocr/ocrinput/add#add_1)(byte[], int, int, PixelType) | 将解码后的图像添加到列表中以进行识别/处理。图像的类型必须与构造函数中指定的类型（SingleImage）相匹配。 |
| [AddBase64](../../aspose.ocr/ocrinput/addbase64)(string) | 添加包含图像的 base64 字符串以进行识别/处理。图像的类型必须与构造函数中指定的类型相匹配。 |
| [Clear](../../aspose.ocr/ocrinput/clear)() | 将处理/识别的项目数量设置为 0。清空集合。 |
| [ClearFilters](../../aspose.ocr/ocrinput/clearfilters)() | 移除所有过滤器。 |
| [Count](../../aspose.ocr/ocrinput/count)() | 处理/识别的项目数量。 |
| [Dispose](../../aspose.ocr/ocrinput/dispose)() | 将处理/识别的项目数量设置为 0。清空集合。 |
| [GetEnumerator](../../aspose.ocr/ocrinput/getenumerator)() | 返回集合枚举器。 |
| [GetInputType](../../aspose.ocr/ocrinput/getinputtype)() | 用于识别的允许图像类型。 |
| [ReplaceFilters](../../aspose.ocr/ocrinput/replacefilters)(PreprocessingFilter) | 移除旧过滤器并设置新的。 |
