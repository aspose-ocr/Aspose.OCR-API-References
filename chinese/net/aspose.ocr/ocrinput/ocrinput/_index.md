...
description: 构造函数用于创建容器并设置图像/文档的类型以及用于进一步预处理/识别的过滤器。
type: docs
weight: 10
url: /zh/net/aspose.ocr/ocrinput/ocrinput/
---
## OcrInput constructor

构造函数用于创建容器并设置图像/文档的类型以及用于进一步预处理/识别的过滤器。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 类型 | InputType | 设置将添加到容器的图像/文档类型。 |
| 过滤器 | PreprocessingFilter | 设置预处理过滤器，将用于后续处理或识别。 |
