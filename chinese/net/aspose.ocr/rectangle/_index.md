...
| [IsEmpty](../../aspose.ocr/rectangle/isempty) { get; } | 获取一个值，指示此 [`Rectangle`](../rectangle) 的所有数值属性是否全部为零。 |
...
| override [Equals](../../aspose.ocr/rectangle/equals)(object) | 测试 *obj* 是否为具有相同位置和大小的 [`Rectangle`](../rectangle) 结构。 |
...
| [operator ==](../../aspose.ocr/rectangle/op_equality) | 测试两个 [`Rectangle`](../rectangle) 结构的位置信息和大小是否相等。 |
| [operator !=](../../aspose.ocr/rectangle/op_inequality) | 测试两个 [`Rectangle`](../rectangle) 结构的位置信息或大小是否不同。 |
