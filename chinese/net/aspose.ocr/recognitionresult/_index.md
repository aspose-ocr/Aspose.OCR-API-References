...
| 名称 | 描述 |
| --- | --- |
| [RecognitionResult](recognitionresult)() | 初始化一个新的 [`RecognitionResult`](../recognitionresult) 类实例。 |
...
| 名称 | 描述 |
| --- | --- |
| class [LinesResult](recognitionresult.linesresult) | 带有行坐标的行识别文本。 |
| class [RegionResult](recognitionresult.regionresult) | 带有区域坐标的区域识别文本。 |
