...
| 名称 | 描述 |
| :- | :- |
| recognize(images) | 识别图像/文档中的文本。<br/>            支持 GIF、PNG、JPEG、BMP、TIFF、JFIF、流、目录、数组、存档。 |
| recognize(images, preset) |  |
| recognize(images, settings) | 识别图像/文档中的文本。<br/>            支持 GIF、PNG、JPEG、BMP、TIFF、JFIF、流、目录、数组、存档。 |
| recognize_receipt(images) | 识别收据中的文本。 |
| recognize_receipt(images, settings) | 识别收据中的文本。 |
| recognize_invoice(images) | 识别发票中的文本。 |
| recognize_invoice(images, settings) | 识别发票中的文本。 |
...
| recognize_lines(images) | 识别包含单行文本的图像。<br/>            支持 GIF、PNG、JPEG、BMP、TIFF、JFIF、流、文件夹、数组、存档。 |
| recognize_lines(images, settings) | 识别包含单行文本的图像。<br/>            支持 GIF、PNG、JPEG、BMP、TIFF、JFIF、流、文件夹、数组、存档。 |
| detect_rectangles(images) | 检测图像上的文本区域。<br/>            支持 GIF、PNG、JPEG、BMP、TIFF、JFIF、流、文件夹、数组、存档。 |
| detect_rectangles(images, areas_type, detect_areas) | 检测图像上的文本区域。<br/>            支持 GIF、PNG、JPEG、BMP、TIFF、JFIF、流、文件夹、数组、存档。 |
| recognize_characters(images) | 检测图像上的符号。<br/>            支持 GIF、PNG、JPEG、BMP、TIFF、JFIF、流、文件夹、数组、存档。 |
| recognize_characters(images, detect_areas_mode, language) | 检测图像上的符号。<br/>            支持 GIF、PNG、JPEG、BMP、TIFF、JFIF、流、文件夹、数组、存档。 |
...
| recognize_fast(images) | 识别图像/文档中的文本。<br/>            支持 GIF、PNG、JPEG、BMP、TIFF、JFIF、流、目录、数组、存档。 |
| recognize_handwritten_text(images) | 识别图像中的手写文本。 |
...
| calculate_skew(images) | 计算图像的倾斜角度。<br/>            支持 GIF、PNG、JPEG、BMP、TIFF、JFIF、流、文件夹、数组和归档。 |
