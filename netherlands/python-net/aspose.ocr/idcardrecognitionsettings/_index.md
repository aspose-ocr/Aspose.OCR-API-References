...
type: docs
weight: 100
url: /nl/python-net/aspose.ocr/idcardrecognitionsettings/
---

## IDCardRecognitionSettings class

Instellingen voor de ID-kaartherkenning.<br/>            Bevat elementen die het aanpassen van het herkenningsproces mogelijk maken.

Het type IDCardRecognitionSettings bevat de volgende leden:
## Constructors
| Naam | Beschrijving |
| :- | :- |
| IDCardRecognitionSettings(language) | Initialiseert een nieuw exemplaar van de klasse IDCardRecognitionSettings |
| IDCardRecognitionSettings() | Initialiseert een nieuw exemplaar van de |
## Eigenschappen
| Naam | Beschrijving |
| :- | :- |
