...
description: "Instellingen voor de factuurherkenning bevatten elementen die het aanpassen van het herkenningsproces mogelijk maken."
type: docs
weight: 17
url: /nl/java/com.aspose.ocr/invoicerecognitionsettings/
---
...
Instellingen voor de factuurherkenning bevatten elementen die het aanpassen van het herkenningsproces mogelijk maken.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [InvoiceRecognitionSettings()](#InvoiceRecognitionSettings) | Standaardconstructor: stel autoSkew in op true. |
## Methoden
