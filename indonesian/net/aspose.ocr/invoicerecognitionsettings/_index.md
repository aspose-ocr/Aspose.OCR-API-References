...
description: Aspose.OCR.InvoiceRecognitionSettings kelas. Pengaturan untuk pengenalan faktur. Berisi elemen yang memungkinkan penyesuaian proses pengenalan.
type: docs
weight: 100
url: /id/net/aspose.ocr/invoicerecognitionsettings/
---
## InvoiceRecognitionSettings class

Pengaturan untuk pengenalan faktur. Berisi elemen yang memungkinkan penyesuaian proses pengenalan.
...
| Nama | Keterangan |
| --- | --- |
| [InvoiceRecognitionSettings](invoicerecognitionsettings/)(Language) | Menginisialisasi instance baru dari`InvoiceRecognitionSettings`kelas dengan set properti lengkap. |
