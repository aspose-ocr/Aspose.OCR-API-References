...
description: Aspose.OCR.InvoiceRecognitionSettings 수업. 송장 인식 설정. 인식 프로세스를 사용자 정의할 수 있는 요소를 포함합니다.
type: docs
weight: 100
url: /ko/net/aspose.ocr/invoicerecognitionsettings/
---
## InvoiceRecognitionSettings class

송장 인식 설정. 인식 프로세스를 사용자 정의할 수 있는 요소를 포함합니다.
...
| 이름 | 설명 |
| --- | --- |
| [InvoiceRecognitionSettings](invoicerecognitionsettings/)(Language) | 의 새 인스턴스를 초기화합니다.`InvoiceRecognitionSettings`전체 속성 세트가 있는 클래스. |
