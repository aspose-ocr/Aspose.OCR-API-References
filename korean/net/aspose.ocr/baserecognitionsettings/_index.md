...
description: Aspose.OCR.BaseRecognitionSettings 수업. 이미지 인식 설정. 인식 프로세스를 사용자 정의할 수 있는 요소를 포함합니다.
type: docs
weight: 30
url: /ko/net/aspose.ocr/baserecognitionsettings/
---
...
| 이름 | 설명 |
| --- | --- |
| [BaseRecognitionSettings](baserecognitionsettings/)(Language, bool, float, int) | 의 새 인스턴스를 초기화합니다.[`RecognitionSettings`](../recognitionsettings/)전체 속성 세트가 있는 클래스. |
...
| [SkewAngle](../../aspose.ocr/baserecognitionsettings/skewangle/) { set; } | 이미지 회전 각도를 가져오거나 설정합니다.  이 값을 설정하면[`AutoSkew`](./autoskew/) 자동 기울이기 보정이 적용되지 않도록 합니다. 기본적으로 0입니다. |
