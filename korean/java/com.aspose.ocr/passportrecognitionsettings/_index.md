...
description: "여권 인식을 위한 설정은 인식 프로세스를 사용자 정의할 수 있는 요소를 포함합니다."
type: docs
weight: 23
url: /ko/java/com.aspose.ocr/passportrecognitionsettings/
---
...
여권 인식을 위한 설정은 인식 프로세스를 사용자 정의할 수 있는 요소를 포함합니다.
## 생성자
...
| [setCountry(Country country)](#setCountry-com.aspose.ocr.models.Country) | 여권 인식을 위한 템플릿을 설정하고 키워드를 추출합니다. |
...
여권 인식을 위한 템플릿을 설정하고 키워드를 추출합니다.

**Parameters:**
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| country | [Country](../../com.aspose.ocr.models/country/) | 여권 국가. |
