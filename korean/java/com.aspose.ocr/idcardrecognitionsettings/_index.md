...
description: "신분증 인식을 위한 설정은 인식 프로세스를 사용자 정의할 수 있는 요소를 포함합니다."
type: docs
weight: 14
url: /ko/java/com.aspose.ocr/idcardrecognitionsettings/
---
...
신분증 인식을 위한 설정은 인식 프로세스를 사용자 정의할 수 있는 요소를 포함합니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [IDCardRecognitionSettings()](#IDCardRecognitionSettings) | 기본 생성자: autoSkew를 true로 설정합니다. |
## 메서드
