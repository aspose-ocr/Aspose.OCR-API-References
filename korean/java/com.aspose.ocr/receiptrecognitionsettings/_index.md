...
description: "영수증 인식을 위한 설정은 인식 프로세스를 사용자 정의할 수 있는 요소를 포함합니다."
type: docs
weight: 25
url: /ko/java/com.aspose.ocr/receiptrecognitionsettings/
---
...
영수증 인식을 위한 설정은 인식 프로세스를 사용자 정의할 수 있는 요소를 포함합니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [ReceiptRecognitionSettings()](#ReceiptRecognitionSettings) | 기본 생성자: autoSkew를 true로 설정합니다. |
## 메서드
