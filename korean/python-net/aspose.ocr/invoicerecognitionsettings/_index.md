...
type: docs
weight: 130
url: /ko/python-net/aspose.ocr/invoicerecognitionsettings/
---

## InvoiceRecognitionSettings class

청구서 인식을 위한 설정.<br/>            인식 프로세스를 사용자 정의할 수 있는 요소를 포함합니다.

InvoiceRecognitionSettings 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| InvoiceRecognitionSettings(language) | InvoiceRecognitionSettings 클래스의 새 인스턴스를 초기화합니다 |
| InvoiceRecognitionSettings() | 새 인스턴스를 초기화합니다 |
## 속성
| 이름 | 설명 |
| :- | :- |
