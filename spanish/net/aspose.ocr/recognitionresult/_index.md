...
description: Los resultados del reconocimiento de imágenes. Contiene elementos con información de reconocimiento y métodos para la exportación de resultados.
type: docs
weight: 110
