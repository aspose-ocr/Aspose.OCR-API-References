...
description: Aspose.OCR.ReceiptRecognitionSettings clase. Configuración para el reconocimiento de recibos. Contiene elementos que permiten personalizar el proceso de reconocimiento.
type: docs
weight: 210
url: /es/net/aspose.ocr/receiptrecognitionsettings/
---
## ReceiptRecognitionSettings class

Configuración para el reconocimiento de recibos. Contiene elementos que permiten personalizar el proceso de reconocimiento.
...
| Nombre | Descripción |
| --- | --- |
| [ReceiptRecognitionSettings](receiptrecognitionsettings/)(Language) | Inicializa una nueva instancia del`ReceiptRecognitionSettings`clase con conjunto completo de propiedades. |
