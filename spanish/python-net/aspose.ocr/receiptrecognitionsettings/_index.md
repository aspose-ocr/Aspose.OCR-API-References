...
type: docs
weight: 280
url: /es/python-net/aspose.ocr/receiptrecognitionsettings/
---

## ReceiptRecognitionSettings class

Configuración para el reconocimiento de recibos.<br/>            Contiene elementos que permiten personalizar el proceso de reconocimiento.

El tipo ReceiptRecognitionSettings expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| ReceiptRecognitionSettings(language) | Inicializa una nueva instancia de la clase ReceiptRecognitionSettings |
| ReceiptRecognitionSettings() | Inicializa una nueva instancia de |
## Propiedades
| Nombre | Descripción |
| :- | :- |
