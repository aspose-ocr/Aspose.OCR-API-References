...
type: docs
weight: 100
url: /es/python-net/aspose.ocr/idcardrecognitionsettings/
---

## IDCardRecognitionSettings class

Configuración para el reconocimiento de tarjetas de identificación.<br/>            Contiene elementos que permiten personalizar el proceso de reconocimiento.

El tipo IDCardRecognitionSettings expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| IDCardRecognitionSettings(language) | Inicializa una nueva instancia de la clase IDCardRecognitionSettings |
| IDCardRecognitionSettings() | Inicializa una nueva instancia de |
## Propiedades
| Nombre | Descripción |
| :- | :- |
