...
description: "Configuración para el reconocimiento de recibos contiene elementos que permiten personalizar el proceso de reconocimiento."
type: docs
weight: 25
url: /es/java/com.aspose.ocr/receiptrecognitionsettings/
---
...
| --- | --- |
| [ReceiptRecognitionSettings()](#ReceiptRecognitionSettings) | Constructor predeterminado: establecer autoSkew en true. |
## Métodos
