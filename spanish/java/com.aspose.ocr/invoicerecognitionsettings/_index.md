...
description: "Configuración para el reconocimiento de facturas contiene elementos que permiten personalizar el proceso de reconocimiento."
type: docs
weight: 17
url: /es/java/com.aspose.ocr/invoicerecognitionsettings/
---
...
| --- | --- |
| [InvoiceRecognitionSettings()](#InvoiceRecognitionSettings) | Constructor predeterminado: establecer autoSkew en true. |
## Métodos
