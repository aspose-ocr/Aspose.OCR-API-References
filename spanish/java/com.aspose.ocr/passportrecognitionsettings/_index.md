...
description: "Configuración para el reconocimiento de pasaportes contiene elementos que permiten personalizar el proceso de reconocimiento."
type: docs
weight: 23
url: /es/java/com.aspose.ocr/passportrecognitionsettings/
---
...
Configuración para el reconocimiento de pasaportes contiene elementos que permiten personalizar el proceso de reconocimiento.
## Constructores
...
| [setCountry(Country country)](#setCountry-com.aspose.ocr.models.Country) | Establezca la plantilla para el reconocimiento de pasaportes y para extraer las palabras clave. |
...
Establezca la plantilla para el reconocimiento de pasaportes y para extraer las palabras clave.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| country | [Country](../../com.aspose.ocr.models/country/) | país del pasaporte. |
