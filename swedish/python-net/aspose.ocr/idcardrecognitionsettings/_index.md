...
type: docs
weight: 100
url: /sv/python-net/aspose.ocr/idcardrecognitionsettings/
---

## IDCardRecognitionSettings class

Inställningar för ID-kortigenkänning.<br/>            Innehåller element som möjliggör anpassning av igenkänningsprocessen.

Typen IDCardRecognitionSettings visar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| IDCardRecognitionSettings(language) | Initierar en ny instans av klassen IDCardRecognitionSettings |
| IDCardRecognitionSettings() | Initierar en ny instans av |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
