...
description: "Inställningar för kvittigenkänning innehåller element som möjliggör anpassning av igenkänningsprocessen"
type: docs
weight: 25
url: /sv/java/com.aspose.ocr/receiptrecognitionsettings/
---
...
Inställningar för kvittigenkänning innehåller element som möjliggör anpassning av igenkänningsprocessen
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [ReceiptRecognitionSettings()](#ReceiptRecognitionSettings) | Standardkonstruktor: sätt autoSkew till true. |
## Metoder
