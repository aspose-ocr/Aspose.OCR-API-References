...
description: "Inställningar för ID-kortigenkänning innehåller element som möjliggör anpassning av igenkänningsprocessen"
type: docs
weight: 14
url: /sv/java/com.aspose.ocr/idcardrecognitionsettings/
---
...
| --- | --- |
| [IDCardRecognitionSettings()](#IDCardRecognitionSettings) | Standardkonstruktor: sätt autoSkew till true. |
## Metoder
