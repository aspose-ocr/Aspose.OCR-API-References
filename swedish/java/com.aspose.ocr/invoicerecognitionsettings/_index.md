...
description: "Inställningar för fakturagenkänning innehåller element som möjliggör anpassning av igenkänningsprocessen"
type: docs
weight: 17
url: /sv/java/com.aspose.ocr/invoicerecognitionsettings/
---
...
Inställningar för fakturagenkänning innehåller element som möjliggör anpassning av igenkänningsprocessen
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [InvoiceRecognitionSettings()](#InvoiceRecognitionSettings) | Standardkonstruktor: sätt autoSkew till true. |
## Metoder
