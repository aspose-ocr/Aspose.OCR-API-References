...
description: Aspose.OCR.PassportRecognitionSettings klass. Inställningar för passigenkänning. Innehåller element som gör det möjligt att anpassa igenkänningsprocessen.
type: docs
weight: 190
url: /sv/net/aspose.ocr/passportrecognitionsettings/
---
## PassportRecognitionSettings class

Inställningar för passigenkänning. Innehåller element som gör det möjligt att anpassa igenkänningsprocessen.
...
| namn | Beskrivning |
| --- | --- |
| [PassportRecognitionSettings](passportrecognitionsettings/)(Language) | Initierar en ny instans av`PassportRecognitionSettings`klass med fullständig uppsättning egenskaper. |
