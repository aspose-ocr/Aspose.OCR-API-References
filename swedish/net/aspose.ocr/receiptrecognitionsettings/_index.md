...
description: Aspose.OCR.ReceiptRecognitionSettings klass. Inställningar för kvittotigenkänningen. Innehåller element som gör det möjligt att anpassa igenkänningsprocessen.
type: docs
weight: 210
url: /sv/net/aspose.ocr/receiptrecognitionsettings/
---
...
| namn | Beskrivning |
| --- | --- |
| [ReceiptRecognitionSettings](receiptrecognitionsettings/)(Language) | Initierar en ny instans av`ReceiptRecognitionSettings`klass med fullständig uppsättning egenskaper. |
