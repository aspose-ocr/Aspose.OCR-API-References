...
description: Konverterar en bild till svartvit bild. Binära bilder är bilder vars pixlar bara har två möjliga intensitetsvärden. De visas normalt som svartvita. Numeriskt är de två värdena ofta 0 för svart och 255 för vit. Binära bilder produceras genom automatisk tröskelvärde för en bild.
type: docs
weight: 40
