...
description: "Einstellungen für die Rechnungserkennung enthalten Elemente, die die Anpassung des Erkennungsprozesses ermöglichen."
type: docs
weight: 17
url: /de/java/com.aspose.ocr/invoicerecognitionsettings/
---
...
Einstellungen für die Rechnungserkennung enthalten Elemente, die die Anpassung des Erkennungsprozesses ermöglichen.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [InvoiceRecognitionSettings()](#InvoiceRecognitionSettings) | Standardkonstruktor: setze autoSkew auf true. |
## Methoden
