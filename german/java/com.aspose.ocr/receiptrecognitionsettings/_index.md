...
description: "Einstellungen für die Beleg‑Erkennung enthalten Elemente, die die Anpassung des Erkennungsprozesses ermöglichen."
type: docs
weight: 25
url: /de/java/com.aspose.ocr/receiptrecognitionsettings/
---
...
Einstellungen für die Beleg‑Erkennung enthalten Elemente, die die Anpassung des Erkennungsprozesses ermöglichen.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [ReceiptRecognitionSettings()](#ReceiptRecognitionSettings) | Standardkonstruktor: setze autoSkew auf true. |
## Methoden
