...
description: "Einstellungen für die Personalausweis‑Erkennung enthalten Elemente, die die Anpassung des Erkennungsprozesses ermöglichen."
type: docs
weight: 14
url: /de/java/com.aspose.ocr/idcardrecognitionsettings/
---
...
Einstellungen für die Personalausweis‑Erkennung enthalten Elemente, die die Anpassung des Erkennungsprozesses ermöglichen.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [IDCardRecognitionSettings()](#IDCardRecognitionSettings) | Standardkonstruktor: setze autoSkew auf true. |
## Methoden
