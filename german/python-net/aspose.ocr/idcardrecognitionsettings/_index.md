...
type: docs
weight: 100
url: /de/python-net/aspose.ocr/idcardrecognitionsettings/
---

## IDCardRecognitionSettings class

Einstellungen für die Personalausweis-Erkennung.<br/>            Enthält Elemente, die die Anpassung des Erkennungsprozesses ermöglichen.

Der IDCardRecognitionSettings-Typ stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| IDCardRecognitionSettings(language) | Initialisiert eine neue Instanz der Klasse IDCardRecognitionSettings |
| IDCardRecognitionSettings() | Initialisiert eine neue Instanz von |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
