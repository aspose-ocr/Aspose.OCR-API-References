...
type: docs
weight: 280
url: /de/python-net/aspose.ocr/receiptrecognitionsettings/
---

## ReceiptRecognitionSettings class

Einstellungen für die Belegerkennung.<br/>            Enthält Elemente, die die Anpassung des Erkennungsprozesses ermöglichen.

Der Typ ReceiptRecognitionSettings stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| ReceiptRecognitionSettings(language) | Initialisiert eine neue Instanz der Klasse ReceiptRecognitionSettings |
| ReceiptRecognitionSettings() | Initialisiert eine neue Instanz von |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
