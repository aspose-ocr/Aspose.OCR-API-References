...
type: docs
weight: 130
url: /de/python-net/aspose.ocr/invoicerecognitionsettings/
---

## InvoiceRecognitionSettings class

Einstellungen für die Rechnungserkennung.<br/>            Enthält Elemente, die die Anpassung des Erkennungsprozesses ermöglichen.

Der Typ InvoiceRecognitionSettings stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| InvoiceRecognitionSettings(language) | Initialisiert eine neue Instanz der Klasse InvoiceRecognitionSettings |
| InvoiceRecognitionSettings() | Initialisiert eine neue Instanz von |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
