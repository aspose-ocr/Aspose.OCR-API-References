...
| Name | Description |
| --- | --- |
| [BaseRecognitionSettings](baserecognitionsettings)(Language, bool, float, bool, int) | Initializes a new instance of the [`RecognitionSettings`](../recognitionsettings) class with full set of properties. |
