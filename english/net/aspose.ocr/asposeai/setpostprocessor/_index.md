...
type: docs
weight: 80
url: /net/aspose.ocr/asposeai/setpostprocessor/
---
...
| --- | --- | --- |
| processor | IOcrAIPostProcessor | An implementation of [`IOcrAIPostProcessor`](../../../aspose.ocr.ai/iocraipostprocessor) that defines the logic for AI-based post-processing (e.g., spell-checking, table extraction, or layout correction). |
