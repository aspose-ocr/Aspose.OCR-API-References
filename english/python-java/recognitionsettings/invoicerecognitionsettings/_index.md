...
linktitle: "InvoiceRecognitionSettings"
second_title: "Aspose.OCR for Python via Java"
description: ""
type: docs
weight: 10
url: /python-java/recognitionsettings/invoicerecognitionsettings/
---
...
| --- | --- | --- |
| [JAVA_CLASS_NAME](#java_class_name) | `"com.aspose.ocr.InvoiceRecognitionSettings"` |  |

### InvoiceRecognitionSettings Constructor {#constructor}

```python
__init__(self)
```

### InvoiceRecognitionSettings.set_allowed_characters {#set_allowed_characters}
...
### InvoiceRecognitionSettings.set_automatic_color_inversion {#set_automatic_color_inversion}
...
### InvoiceRecognitionSettings.set_ignored_characters {#set_ignored_characters}
...
### InvoiceRecognitionSettings.set_language {#set_language}
...
### InvoiceRecognitionSettings.set_threads_count {#set_threads_count}
...
### InvoiceRecognitionSettings.set_upscale_small_font {#set_upscale_small_font}
...
### InvoiceRecognitionSettings.JAVA_CLASS_NAME {#java_class_name}

**Type:** `str`

**Value:** `"com.aspose.ocr.InvoiceRecognitionSettings"`
