...
linktitle: "CarPlateRecognitionSettings"
second_title: "Aspose.OCR for Python via Java"
description: ""
type: docs
weight: 10
url: /python-java/recognitionsettings/carplaterecognitionsettings/
---
...
| --- | --- | --- |
| [JAVA_CLASS_NAME](#java_class_name) | `"com.aspose.ocr.CarPlateRecognitionSettings"` |  |

### CarPlateRecognitionSettings Constructor {#constructor}

```python
__init__(self)
```

### CarPlateRecognitionSettings.set_allowed_characters {#set_allowed_characters}
...
### CarPlateRecognitionSettings.set_ignored_characters {#set_ignored_characters}
...
### CarPlateRecognitionSettings.set_language {#set_language}
...
### CarPlateRecognitionSettings.set_threads_count {#set_threads_count}
...
### CarPlateRecognitionSettings.JAVA_CLASS_NAME {#java_class_name}
