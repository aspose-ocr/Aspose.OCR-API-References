...
linktitle: "PassportRecognitionSettings"
second_title: "Aspose.OCR for Python via Java"
description: ""
type: docs
weight: 10
url: /python-java/recognitionsettings/passportrecognitionsettings/
---
...
| --- | --- | --- |
| [JAVA_CLASS_NAME](#java_class_name) | `"com.aspose.ocr.PassportRecognitionSettings"` |  |

### PassportRecognitionSettings Constructor {#constructor}

```python
__init__(self)
```

### PassportRecognitionSettings.set_allowed_characters {#set_allowed_characters}
...
### PassportRecognitionSettings.set_automatic_color_inversion {#set_automatic_color_inversion}
...
### PassportRecognitionSettings.set_ignored_characters {#set_ignored_characters}
...
### PassportRecognitionSettings.set_language {#set_language}
...
### PassportRecognitionSettings.set_threads_count {#set_threads_count}
...
### PassportRecognitionSettings.set_upscale_small_font {#set_upscale_small_font}
...
### PassportRecognitionSettings.JAVA_CLASS_NAME {#java_class_name}

**Type:** `str`

**Value:** `"com.aspose.ocr.PassportRecognitionSettings"`
