...
### PreprocessingFilter Constructor {#constructor}

```python
__init__(self)
```

### PreprocessingFilter.add {#add}
...
### PreprocessingFilter.auto_denoising (static) {#auto_denoising}
...
### PreprocessingFilter.auto_dewarping (static) {#auto_dewarping}
...
### PreprocessingFilter.auto_skew (static) {#auto_skew}
...
### PreprocessingFilter.binarize (static) {#binarize}
...
### PreprocessingFilter.binarize_and_dilate (static) {#binarize_and_dilate}
...
### PreprocessingFilter.contrast_correction (static) {#contrast_correction}
...
### PreprocessingFilter.getJavaClass {#getjavaclass}

```python
getJavaClass(self)
```

### PreprocessingFilter.invert (static) {#invert}
...
### PreprocessingFilter.median (static) {#median}
...
### PreprocessingFilter.resize (static) {#resize}
...
### PreprocessingFilter.rotate (static) {#rotate}
...
### PreprocessingFilter.scale (static) {#scale}
...
### PreprocessingFilter.threshold (static) {#threshold}
...
### PreprocessingFilter.to_grayscale (static) {#to_grayscale}
...
### PreprocessingFilter.JAVA_CLASS_NAME {#java_class_name}
