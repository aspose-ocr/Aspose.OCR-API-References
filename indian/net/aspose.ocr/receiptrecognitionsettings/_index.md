...
description: Aspose.OCR.ReceiptRecognitionSettings कक्ष. रसद पहचन के लए सेटंग्स में ऐसे तत्व शमल हैं ज पहचन प्रक्रय क अनुकूलत करने क अनुमत देते हैं
type: docs
weight: 210
url: /hi/net/aspose.ocr/receiptrecognitionsettings/
---
## ReceiptRecognitionSettings class

रसीद पहचान के लिए सेटिंग्स। में ऐसे तत्व शामिल हैं जो पहचान प्रक्रिया को अनुकूलित करने की अनुमति देते हैं।
...
| नाम | विवरण |
| --- | --- |
| [ReceiptRecognitionSettings](receiptrecognitionsettings/)(Language) | का एक नया उदाहरण प्रारंभ करता है`ReceiptRecognitionSettings`गुणों के पूर्ण सेट के साथ वर्ग। |
