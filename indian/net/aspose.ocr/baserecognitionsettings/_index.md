...
description: Aspose.OCR.BaseRecognitionSettings कक्ष. छव पहचन के लए सेटंग्स में ऐसे तत्व शमल हैं ज पहचन प्रक्रय क अनुकूलत करने क अनुमत देते हैं
type: docs
weight: 30
url: /hi/net/aspose.ocr/baserecognitionsettings/
---
...
| नाम | विवरण |
| --- | --- |
| [BaseRecognitionSettings](baserecognitionsettings/)(Language, bool, float, int) | का एक नया उदाहरण प्रारंभ करता है[`RecognitionSettings`](../recognitionsettings/)गुणों के पूर्ण सेट के साथ वर्ग। |
...
| [SkewAngle](../../aspose.ocr/baserecognitionsettings/skewangle/) { set; } | इमेज रोटेशन के लिए डिग्री में कोण प्राप्त या सेट करता है।  इस मान को सेट करने से अक्षम हो जाएगा[`AutoSkew`](./autoskew/) संपत्ति, ताकि ऑटो तिरछा सुधार लागू न हो। डिफ़ॉल्ट रूप से शून्य। |
