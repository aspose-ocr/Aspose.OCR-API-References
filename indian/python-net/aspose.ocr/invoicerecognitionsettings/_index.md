...
type: docs
weight: 130
url: /hi/python-net/aspose.ocr/invoicerecognitionsettings/
---

## InvoiceRecognitionSettings class

इनवॉइस पहचान के लिए सेटिंग्स।<br/>            पहचान प्रक्रिया को अनुकूलित करने की अनुमति देने वाले तत्व शामिल हैं।

InvoiceRecognitionSettings प्रकार निम्नलिखित सदस्यों को उजागर करता है:
## निर्माता
| नाम | विवरण |
| :- | :- |
| InvoiceRecognitionSettings(language) | InvoiceRecognitionSettings वर्ग की नई उदाहरण को प्रारंभ करता है |
| InvoiceRecognitionSettings() | नया उदाहरण प्रारंभ करता है |
## गुणधर्म
| नाम | विवरण |
| :- | :- |
