...
type: docs
weight: 280
url: /hi/python-net/aspose.ocr/receiptrecognitionsettings/
---

## ReceiptRecognitionSettings class

रसीद पहचान के लिए सेटिंग्स।<br/>            पहचान प्रक्रिया को अनुकूलित करने की अनुमति देने वाले तत्व शामिल हैं।

ReceiptRecognitionSettings प्रकार निम्नलिखित सदस्यों को उजागर करता है:
## निर्माता
| नाम | विवरण |
| :- | :- |
| ReceiptRecognitionSettings(language) | ReceiptRecognitionSettings क्लास का नया इंस्टेंस प्रारंभ करता है |
| ReceiptRecognitionSettings() | नया उदाहरण प्रारंभ करता है |
## गुणधर्म
| नाम | विवरण |
| :- | :- |
