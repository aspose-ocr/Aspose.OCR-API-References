...
type: docs
weight: 40
url: /hi/python-net/aspose.ocr/carplaterecognitionsettings/
---

## CarPlateRecognitionSettings class

कार नंबर पहचान के लिए सेटिंग्स।<br/>            पहचान प्रक्रिया को अनुकूलित करने की अनुमति देने वाले तत्व शामिल हैं।

CarPlateRecognitionSettings प्रकार निम्नलिखित सदस्यों को उजागर करता है:
## निर्माता
| नाम | विवरण |
| :- | :- |
| CarPlateRecognitionSettings(language) | CarPlateRecognitionSettings वर्ग का एक नया उदाहरण प्रारंभ करता है। |
| CarPlateRecognitionSettings() | नया उदाहरण प्रारंभ करता है |
## गुणधर्म
| नाम | विवरण |
| :- | :- |
