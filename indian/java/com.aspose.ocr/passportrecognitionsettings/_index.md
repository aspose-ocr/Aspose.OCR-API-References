...
description: "पासपोर्ट पहचान के लिए सेटिंग्स में ऐसे तत्व शामिल हैं जो पहचान प्रक्रिया को अनुकूलित करने की अनुमति देते हैं।"
type: docs
weight: 23
url: /hi/java/com.aspose.ocr/passportrecognitionsettings/
---
...
| [setCountry(Country country)](#setCountry-com.aspose.ocr.models.Country) | पासपोर्ट पहचान के लिए टेम्पलेट सेट करें और कीवर्ड निकालें। |
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| country | [Country](../../com.aspose.ocr.models/country/) | पासपोर्ट देश। |
