...
description: "आईडी कार्ड पहचान के लिए सेटिंग्स में ऐसे तत्व शामिल हैं जो पहचान प्रक्रिया को अनुकूलित करने की अनुमति देते हैं।"
type: docs
weight: 14
url: /hi/java/com.aspose.ocr/idcardrecognitionsettings/
---
...
| निर्माता | विवरण |
| --- | --- |
| [IDCardRecognitionSettings()](#IDCardRecognitionSettings) | डिफ़ॉल्ट कंस्ट्रक्टर: autoSkew को true सेट करें। |
## विधियाँ
