...
description: "領収書認識の設定。認識プロセスをカスタマイズできる要素が含まれています。"
type: docs
weight: 25
url: /ja/java/com.aspose.ocr/receiptrecognitionsettings/
---
...
領収書認識の設定。認識プロセスをカスタマイズできる要素が含まれています。
## コンストラクタ

| コンストラクタ | 説明 |
| --- | --- |
| [ReceiptRecognitionSettings()](#ReceiptRecognitionSettings) | デフォルトコンストラクタ: autoSkew を true に設定します。 |
## メソッド
