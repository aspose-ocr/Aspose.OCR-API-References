...
description: "パスポート認識の設定。認識プロセスをカスタマイズできる要素が含まれています。"
type: docs
weight: 23
url: /ja/java/com.aspose.ocr/passportrecognitionsettings/
---
...
| [setCountry(Country country)](#setCountry-com.aspose.ocr.models.Country) | パスポート認識用のテンプレートを設定し、キーワードを抽出します。 |
...
| パラメータ | タイプ | 説明 |
| --- | --- | --- |
| country | [Country](../../com.aspose.ocr.models/country/) | パスポートの国。 |
