...
description: "ID カード認識の設定。認識プロセスをカスタマイズできる要素が含まれています。"
type: docs
weight: 14
url: /ja/java/com.aspose.ocr/idcardrecognitionsettings/
---
...
| コンストラクタ | 説明 |
| --- | --- |
| [IDCardRecognitionSettings()](#IDCardRecognitionSettings) | デフォルトコンストラクタ: autoSkew を true に設定します。 |
## メソッド
