...
type: docs
weight: 130
url: /ja/python-net/aspose.ocr/invoicerecognitionsettings/
---

## InvoiceRecognitionSettings class

請求書認識の設定。<br/>            カスタマイズ可能な認識プロセスを許可する要素が含まれています。

InvoiceRecognitionSettings 型は次のメンバーを公開します:
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| InvoiceRecognitionSettings(language) | InvoiceRecognitionSettings クラスの新しいインスタンスを初期化します |
| InvoiceRecognitionSettings() | 新しいインスタンスを初期化します |
## プロパティ
| 名前 | 説明 |
| :- | :- |
