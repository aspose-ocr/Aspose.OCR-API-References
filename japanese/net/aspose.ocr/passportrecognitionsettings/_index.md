...
description: Aspose.OCR.PassportRecognitionSettings クラス. パスポート認識の設定. 認識プロセスをカスタマイズできる要素が含まれています.
type: docs
weight: 190
url: /ja/net/aspose.ocr/passportrecognitionsettings/
---
...
| 名前 | 説明 |
| --- | --- |
| [PassportRecognitionSettings](passportrecognitionsettings/)(Language) | の新しいインスタンスを初期化します`PassportRecognitionSettings`プロパティの完全なセットを持つクラス. |
