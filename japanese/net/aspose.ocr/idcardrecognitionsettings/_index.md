...
description: Aspose.OCR.IDCardRecognitionSettings クラス. ID カード認識の設定 認識プロセスをカスタマイズできる要素が含まれています
type: docs
weight: 90
url: /ja/net/aspose.ocr/idcardrecognitionsettings/
---
## IDCardRecognitionSettings class

ID カード認識の設定。 認識プロセスをカスタマイズできる要素が含まれています。
...
| 名前 | 説明 |
| --- | --- |
| [IDCardRecognitionSettings](idcardrecognitionsettings/)(Language) | の新しいインスタンスを初期化します`IDCardRecognitionSettings`プロパティの完全なセットを持つクラス. |
