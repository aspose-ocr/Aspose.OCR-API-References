...
description: Aspose.OCR.BaseRecognitionSettings クラス. 画像認識の設定. 認識プロセスをカスタマイズできる要素が含まれています.
type: docs
weight: 30
url: /ja/net/aspose.ocr/baserecognitionsettings/
---
...
| 名前 | 説明 |
| --- | --- |
| [BaseRecognitionSettings](baserecognitionsettings/)(Language, bool, float, int) | の新しいインスタンスを初期化します[`RecognitionSettings`](../recognitionsettings/)プロパティの完全なセットを持つクラス. |
...
| [SkewAngle](../../aspose.ocr/baserecognitionsettings/skewangle/) { set; } | 画像の回転角度を度単位で取得または設定します。 この値を設定すると、[`AutoSkew`](./autoskew/)自動スキュー補正が適用されないようにします. デフォルトではゼロです. |
