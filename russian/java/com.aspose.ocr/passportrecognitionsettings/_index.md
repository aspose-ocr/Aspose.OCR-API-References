...
description: "Настройки распознавания паспорта содержат элементы, позволяющие настраивать процесс распознавания"
type: docs
weight: 23
url: /ru/java/com.aspose.ocr/passportrecognitionsettings/
---
...
Настройки распознавания паспорта содержат элементы, позволяющие настраивать процесс распознавания
## Конструкторы
...
| [setCountry(Country country)](#setCountry-com.aspose.ocr.models.Country) | Установите шаблон для распознавания паспорта и извлечения ключевых слов. |
...
Установите шаблон для распознавания паспорта и извлечения ключевых слов.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| country | [Country](../../com.aspose.ocr.models/country/) | страна паспорта. |
