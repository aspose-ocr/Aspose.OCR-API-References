...
description: "Настройки распознавания счетов содержат элементы, позволяющие настраивать процесс распознавания"
type: docs
weight: 17
url: /ru/java/com.aspose.ocr/invoicerecognitionsettings/
---
...
| --- | --- |
| [InvoiceRecognitionSettings()](#InvoiceRecognitionSettings) | Конструктор по умолчанию: установить autoSkew в true. |
## Методы
