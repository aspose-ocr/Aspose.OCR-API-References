...
description: "Настройки распознавания чеков содержат элементы, позволяющие настраивать процесс распознавания"
type: docs
weight: 25
url: /ru/java/com.aspose.ocr/receiptrecognitionsettings/
---
...
| --- | --- |
| [ReceiptRecognitionSettings()](#ReceiptRecognitionSettings) | Конструктор по умолчанию: установить autoSkew в true. |
## Методы
