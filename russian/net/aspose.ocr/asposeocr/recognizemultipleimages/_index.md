...
| --- | --- | --- |
| files | List`1 | Полные пути к образам. |
| settings | RecognitionSettings | Настройки распознавания. |

### Возвращаемое значение

Массив объектов[`RecognitionResult`](../../recognitionresult)с результатами распознавания для каждого обработанного изображения.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| path | String | Полный путь к zip-архиву (включая расширение .zip) или к папке с картинки. |
| settings | RecognitionSettings | Настройки распознавания. |
